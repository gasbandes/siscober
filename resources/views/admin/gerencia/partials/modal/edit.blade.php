                    ...
                    <div class="row g-3">
                        <div class="col-xxl-6">
                            <div>
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror" name="ente" placeholder="Nombre del módulo"  id="nombreusuario" aria-describedby="register-name" tabindex="1" autofocus value="{{ old('name') }}" />
                            </div>
                        </div><!--end col-->
                        <div class="col-xxl-6">
                            <div>
                                <label for="lastName" class="form-label">Apellidos</label>
                                <input type="text" name="name" class="form-control" id="apellido" placeholder="Enter lastname">
                            </div>
                        </div>
