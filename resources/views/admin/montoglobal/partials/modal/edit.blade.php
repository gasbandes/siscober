                    ...
                    <div class="row g-3">
                        <div class="col-xxl-12">
                            <div>
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror" name="total" placeholder="Nombre del módulo"  id="montoglobal" aria-describedby="register-name" tabindex="1" autofocus value="{{ old('name') }}" />
                            </div>
                        </div><!--end col-->
                       
                        <div class="col-xxl-12">
                            <div>
                                <label for="passwordInput" class="form-label">Estado del monto global</label>
