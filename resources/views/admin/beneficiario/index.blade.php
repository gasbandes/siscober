       ...
       <div class="container-fluid">
            ...
            <div class="col-lg-12">
              ...
              <div class="card-header">
                ...
                <a href="{{ url('beneficiario/create') }}" class="btn btn-primary" style="float: right !important;"><i class="mdi mdi-plus"></i> Nuevo beneficiario</a>
              </div>
              <div class="card-body">
...
@include('admin.beneficiario.partials.modal.edit')
<!-- end page title -->
@endsection
@push('styles')
 <!-- gridjs css -->
