     ...
     @include('sweetalert::alert')
       <div class="container-fluid">
       	<form role="form" id="facturas-form" autocomplete="off">
              <input type="hidden" id="_url" value="{{ url('reembolsos') }}">
              <input type="hidden" id="_token" value="{{ csrf_token() }}">
    				<div class="card">
    					<div class="card-header">
    						Ingresa los datos del reembolso
    						 <a href="{{ url('reembolsos') }}" class="btn btn-primary" style="float: right !important;"><i class="mdi mdi-plus"></i> Lista de reembolsos</a>
    					</div>
               ...
               <div class="col-lg-12 text-center">
                  ...
                  <label for="status">Estado del reembolso</label>
                  <div class="checkbox icheck">
                    <label>
                      <input type="radio" name="status" value="1" checked> PAGADO&nbsp;&nbsp;
                      <input type="radio" name="status" value="1" > PENDIENTE POR PAGO&nbsp;&nbsp;
                      <input type="radio" name="status" value="1" > ANULADA&nbsp;&nbsp;
                    </label>
                  </div>
                </div>
              </div>
